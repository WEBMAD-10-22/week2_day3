...
// ARRAY que albergue objeto -> título
const newMovies = data.map(({ Title: film, Director: director }) => (
    {
        film,
        director,
    }
...
randomButton.addEventListener('click', function () {
    const randomNumber = ~~(Math.random() * newMovies.length)
    const randomMovie = newMovies[randomNumber].film
    paragraph.innerHTML = randomMovie
    // THIS
